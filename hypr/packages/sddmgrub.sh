...
echo ""
sudo cp ~/archman-dots/sddm/sddm.conf /etc/sddm.conf.d/
sudo cp ~/archman-dots/sddm/sddm.conf /etc/
echo "File /etc/sddm.conf.d/sddm.conf updated."
echo ""
cp ~/archman-dots/default.png ~/.cache/current-wallpaper.png
echo ""
...
echo ""
echo ""
sudo cp ~/archman-dots/sddm/theme.conf /usr/share/sddm/themes/Sugar-Candy/
